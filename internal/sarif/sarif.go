// Package sarif renders engine reports as minimal SARIF 2.1.0 for CI
// annotation. Shared by the CLI's --output sarif and the server's
...
// Write renders the report as minimal SARIF 2.1.0 for CI annotation.
